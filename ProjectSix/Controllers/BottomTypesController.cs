...
namespace ProjectSix.Controllers
{
    public class BottomTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BottomTypesID,BottomTypeName")] BottomType bottomType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomTypesID,BottomTypeName")] BottomType bottomType)
        {
            if (ModelState.IsValid)
            {
