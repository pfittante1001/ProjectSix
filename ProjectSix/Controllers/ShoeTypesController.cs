...
namespace ProjectSix.Controllers
{
    public class ShoeTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ShoeTypeID,ShoesTypeName")] ShoeType shoeType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ShoeTypeID,ShoesTypeName")] ShoeType shoeType)
        {
            if (ModelState.IsValid)
            {
